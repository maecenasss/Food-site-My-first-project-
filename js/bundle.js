...
function calc() {
       ...
       //variable info from inputs from site 
       ...
       function initLocalSettings (selector, activeClass) { //function to reset old data and to put data from localstorage in table-box 'sex' & 'ratio'
       ...
       function getDynamicInformation (selector) {
          ...
          //check info received from user and attention if data - wrong
...
function cards () {
  ...
  // get resourse from server
/*     .then (data => {
      data.forEach(({img, altimg, title, descr, price}) => { */
      //    create menucard and throw it to html file
/*             new MenuCard (img, altimg, title, descr, price, '.menu .container').render()
      });
  }); */

  
  // створення меню карток вручну і відправка на сторінку    
/*     getResource('http://localhost:3000/menu')
      ...
      // request to axios library 
      axios.get ('http://localhost:3000/menu')
          //checking what data we received from server
          .then (data => {
...
window.addEventListener('DOMContentLoaded', () =>  {
    ...
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-07-20');
});
